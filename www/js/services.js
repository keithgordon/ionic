...
.factory('User', function($http, $q, $localstorage, SERVER) {
    ...
    //check if there's a user session persent
    o.checkSession = function() {
        ...
        if (o.session_id) {
            ...
            // if it is , pull into our services
    ...
    // gets the entire list of this users fav from server
    ...
    o.removeSongFromFavorites = function(song, index) {
        ...
        return $http({
            method: 'DELETE',
            url: SERVER.url + '/favorites',
            params: { sesssion_id: o.session_id, song_id:song.song_id }
        });
    }
...
.factory('Recommendations', function($http, $q, SERVER) {
    ...
    //used when siwthcing to favorite tab
